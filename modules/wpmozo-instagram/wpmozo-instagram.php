...
class WPMOZO_Instagram extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'instagram_integration_settings',
			array(
		...
		$this->start_controls_tabs(
			'button_normal_and_hover_state_control_tabs'
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'fields_options' => array(
					'font_size' => array(
						'selectors' => array(
							'{{WRAPPER}} .wpmozo_instagram_button_wrapper_inner:hover svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .wpmozo_instagram_button_wrapper_inner:hover' => 'font-size:{{SIZE}}{{UNIT}};',
						),
	...
	protected function render() {
		...
		if ( isset( $instagram_feed_data ) ) {
			...
			if ( '' !== $button_url ) {
				$this->add_link_attributes(
					'wpmozo_instagram_button_wrapper_inner',
					array(
						'url'         => $button_url,
						'is_external' => true,
						'nofollow'    => true,
		...
		if ( '' !== $settings['button_icon'] ) {
			$button_icon = Icons_Manager::try_get_icon_html(
				...
				array(
					'aria-hidden' => 'true',
					'class'       => 'wpmozo_instagram_button_icon ',
				)
			);
		}
