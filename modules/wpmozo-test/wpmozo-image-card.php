...
class WPMOZO_Image_Card extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .wpmozo-description' => 'text-align: {{icon_position.value}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wpmozo-title-sec .wpmozo-content-icon span.wpmozo-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
			'wpmozo_style_icon_style_icon',
			[
				'label' => esc_html__( 'Style icon', 'textdomain' ),
        ...
        $this->add_control(
			'wpmozo_style_icon_border_style',
			[
				'label' => esc_html__( 'Border Style', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '0',
				'options' => [
					'0' => esc_html__( 'Square', 'textdomain' ),
					'50' => esc_html__( 'Circle', 'textdomain' ),
					
				],
				'selectors' => [
					'{{WRAPPER}} .wpmozo-content-icon span.wpmozo-icon' => 'border-radius: {{VALUE}}%;',
				],
                'condition' => [
                    'wpmozo_style_icon_style_icon' => 'yes',
                ],
			]
		);

        $this->add_control(
			'wpmozo_style_icon_icon_color',
			[
				'label' => esc_html__( 'Background Color', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wpmozo-content-icon span.wpmozo-icon' => 'background-color: {{VALUE}}',
				],
                'condition' => [
                    'wpmozo_style_icon_style_icon' => 'yes',
                ],
        ...
        $this->add_control(
			'wpmozo_style_icon_show_icon_border',
			[
				'label' => esc_html__( 'Show Icon Border', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'textdomain' ),
				'label_off' => esc_html__( 'No', 'textdomain' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			'wpmozo_style_icon_border_color',
			[
				'label' => esc_html__( 'Border Color', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wpmozo-content-icon span.wpmozo-icon' => 'border:3px solid {{VALUE}}',
				],
                'condition' => [
                    'wpmozo_style_icon_show_icon_border' => 'yes',
                ],
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .wpmozo-title-sec .wpmozo-content-icon span.wpmozo-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .wpmozo-title-sec .wpmozo-content-icon span.wpmozo-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    protected function render()
    {
        ...
        // echo '<pre>';
        // print_r($settings['card_icon']);
        // echo '<pre>';

       $content_icon_class = $settings['card_icon']['value'];
        ...
        <div class="wpmozo-main-container">
            ...
            <div class="wpmozo-title-sec">
                <div class="wpmozo-content-icon">
                    <span class="wpmozo-icon <?php echo $content_icon_class; ?>">
                        <?php //\Elementor\Icons_Manager::render_icon($settings['card_icon'], ['aria-hidden' => 'true']); ?>
                    </span>
                    
                </div>
                <h2 class="wpmozo-title">
                    <?php echo $settings['wpmozo_content_title']; ?>
                </h2>
            </div>
            <div class="wpmozo-description-sec">
                <p class="wpmozo-description">
                    <?php echo $settings['wpmozo_content_description']; ?>
                </p>
            </div>
